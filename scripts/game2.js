...
class Resourse{
    ...
    draw(){
       ...
       // ctx.fillRect(this.x,this.y,this.width,this.height);
        ctx.drawImage(coin,this.frameX* this.spriteWidth,0,this.spriteWidth,this.spriteHeight,this.x,this.y,this.width,this.height);
        ctx.fillStyle = 'white';
...
enemy4.src='assetsgame/enemy4.png';
